              ...
              <div className="enquete__dispersion__wrapper02 u-mt-sm">
                <div className="enquete__contents u-m-0a u-w-100">
                  ...
                  <form id="answerForm">
                    ...
                    <div className="u-mt-sm">
                      <h4>今後1年以内に『アルバイト/パート』を採用する可能性はありますか？</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>試用期間中の給料変動はありますか？(アルバイト)　＊試用期間中、基本給が記入額より下がる場合、「はい」を選択ください</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>時給にプラスされる手当がある場合は教えて下さい。(アルバイト)</h4>

                      <input type="text" className="form--type_text formPart" name="1_C7B3TBfct2w75GMW2" placeholder="店販10%、皆勤、交通費" maxlength="500" />
...
export default StylistArbeitTreatment;