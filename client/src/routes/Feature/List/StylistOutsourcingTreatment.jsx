const StylistOutsourcingTreatment = () => {
  return (
              ...
              <div className="enquete__dispersion__wrapper02 u-mt-sm">
                <div className="enquete__contents u-m-0a u-w-100">
                  ...
                  <form id="answerForm">
                    ...
                    <div className="u-mt-sm">
                      <h4>今後1年以内に『業務委託スタイリスト』を採用する可能性はありますか？</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>保障給の受給に条件があれば教えて下さい。(業務委託)　＊保障額も合わせて記載ください</h4>



                      <input type="text" className="form--type_text formPart" name="1_Ztnjwqj6my2h4WyeQ" placeholder="記入例：最低勤務日数〇〇日以上、最低勤務時間〇〇時間" maxlength="500" />
                    ...
                    <div className="u-mt-sm">
                      <h4>給与以外の手当がある場合は教えて下さい。(業務委託)</h4>



                      <input type="text" className="form--type_text formPart" name="1_zznf2zEGibxkWdh2C" maxlength="500" />
                    ...
                    <div className="u-mt-sm">
                      <h4>仮にフルタイムで勤務した場合の平均的な月収イメージを教えて下さい。(業務委託)　＊月収＝月給＋手当＋歩合まで含めた1ヶ月の額面給与</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>薬剤費の本人負担はありますか？(業務委託)　＊別途徴収がある場合は「はい」に回答ください</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>光熱費の本人負担はありますか？(業務委託)　＊別途徴収がある場合は「はい」に回答ください</h4>
...
export default StylistOutsourcingTreatment;