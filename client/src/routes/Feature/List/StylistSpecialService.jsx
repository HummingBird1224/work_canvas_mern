              ...
              <div className="enquete__dispersion__wrapper02 u-mt-sm">
                <div className="enquete__contents u-m-0a u-w-100">
                  ...
                  <form id="answerForm">
                    ...
                    <div className="u-mt-sm">
                      <h4>ヘアセット・ヘアメイクに関して、メディアなど外部との関わりがあれば具体的に教えて下さい。</h4>

                      <input type="text" className="form--type_text formPart" name="1_gr8JhXw5iXhaRcp5k" placeholder="記入例：外部の雑誌やイベント有り" maxlength="500" />

                    </div>

                    <div className="u-mt-sm">
                      <h4>ヘッドスパのメニューはありますか？</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>ヘッドスパ技術を磨くための教育制度があれば、具体的に教えて下さい。</h4>

                      <input type="text" className="form--type_text formPart" name="1_epud2yDvDent5KnxH" placeholder="記入例：スパニストが在籍している" maxlength="500" />

                    </div>

                    <div className="u-mt-sm">
                      <h4>"スパニスト"として働くことは可能ですか？　＊ヘッドスパ専任としての募集がある場合のみ「はい」を選択ください(カットやカラー等しない方)</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>着付けのスキルを磨く教育制度があれば、具体的に教えて下さい。</h4>

                      <input type="text" className="form--type_text formPart" name="1_c3E5QYt6ZzdpHXhoF" placeholder="記入例：七五三など 着付け講師がいる" maxlength="500" />
...
export default StylistSpecialService;