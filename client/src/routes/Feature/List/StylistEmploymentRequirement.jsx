const StylistEmploymentRequirement = () => {
  return (
              ...
              <div className="enquete__dispersion__wrapper02 u-mt-sm">
                <div className="enquete__contents u-m-0a u-w-100">
                  ...
                  <form id="answerForm">
                    ...
                    <div className="u-mt-sm">
                      <h4>時短勤務希望者の採用状況について教えてください。</h4>

                      

                      <div className="u-w-100">
                        <select className="form--type_select u-w-100 formPart" name="3_qCWnZkFPPbvi8rBbp" style={{ borderRadius: 4 }}>
                    ...
                    <div className="u-mt-sm">
                      <h4>美容師免許がない方の採用は可能ですか？ (通信生の採用予定がある場合も、『はい』を選択して下さい)</h4>
                    ...
                    <div className="u-mt-sm">
                      ...
                      <div className="u-w-100">
                        <select className="form--type_select u-w-100 formPart" name="3_7X8yz83CyarLsQvAt" style={{ borderRadius: 4 }}>
                          <option value="">選択してください</option>
                    ...
                    <div className="u-mt-sm">
                      <h4>カラーリストの採用は行っていますか？　＊カラー専任としての募集がある場合のみ「はい」を選択ください(カット等しない方)</h4>
...
export default StylistEmploymentRequirement;