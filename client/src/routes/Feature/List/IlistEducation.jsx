              ...
              <div className="enquete__dispersion__wrapper02 u-mt-sm">
                <div className="enquete__contents u-m-0a u-w-100">
                  ...
                  <div className="u-mt-sm">
                    <h3 className="u-c-darker"><span className="basic_enquete_numbering">1</span>【アイリスト】教育・勤務例</h3>
                  </div>
                  ...
                  <form id="answerForm">
                    ...
                    <div className="u-mt-sm">
                      ...
                      <div className="u-w-100">
                        <select className="form--type_select u-w-100 formPart" name="3_cRp3HAJuPx7QD5JZQ" style={{ borderRadius: 4 }}>
                          <option value="">選択してください</option>

                          <option value="1">営業時間内練習可</option>

                          <option value="2">営業時間不可だが練習自由</option>

                          <option value="3">練習不可</option>
                    ...
                    <div className="u-mt-sm">
                      <h4>ブランクのある求職者向けの不足スキルのフォロー体制はありますか？</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>ママさんアイリストの勤務例で当てはまるものがあれば教えて下さい。</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>アイリストについて、勤務時の服装の指定はありますか？</h4>
                      ...
                      <div className="u-w-100">
                        <select className="form--type_select u-w-100 formPart" name="3_rjbnK2vdXmzvhrQBm" style={{ borderRadius: 4 }}>
                          <option value="">選択してください</option>

                          <option value="1">制服あり</option>

                          <option value="2">その他の服装指定あり（トップスは白限定など）</option>

                          <option value="3">指定なし(制服 / その他服装)</option>
                    ...
                    <div className="u-mt-sm">
                      <h4>アイリスト１人あたりの月間の入客数を教えて下さい。(平均)</h4>
