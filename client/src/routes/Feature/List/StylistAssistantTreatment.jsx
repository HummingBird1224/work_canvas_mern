const StylistAssistantTreatment = () => {
  return (
              ...
              <div className="enquete__dispersion__wrapper02 u-mt-sm">
                <div className="enquete__contents u-m-0a u-w-100">
                  ...
                  <form id="answerForm">
                    ...
                    <div className="u-mt-sm">
                      <h4>今後1年以内に『正社員アシスタント』を採用する可能性はありますか？</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>基本給はおいくらですか？(正社員アシスタント)　＊基本給＝手当や歩合を含まない金額</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>試用期間中も正社員として雇用されますか？(正社員アシスタント)　※最初の数カ月は契約社員としての雇用になる場合は"いいえ"を選択してください</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>試用期間中の給料変動はありますか？(正社員アシスタント)　＊試用期間中、基本給が記入額より下がる場合、「はい」を選択ください</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>アシスタント向けの昇給制度があれば、詳細を教えて下さい。</h4>


                      <input type="text" className="form--type_text formPart" name="1_8MXLNbHrahgoZX7hA" placeholder="記入例：シャンプー習得済みで5000円昇給" maxlength="500" />
                    ...
                    <div className="u-mt-sm">
                      <h4>基本給にプラスされる手当がある場合は、詳細を教えて下さい。(正社員アシスタント)</h4>


                      <input type="text" className="form--type_text formPart" name="1_7RrQtTW2xJY2vzXXo" placeholder="店販10%、皆勤、交通費" maxlength="500" />
                    ...
                    <div className="u-mt-sm">
                      <h4>平均的な月収イメージを教えて下さい。(正社員アシスタント)　＊月収＝月給＋手当＋歩合まで含めた1ヶ月の額面給与</h4>
                    ...
                    <div className="u-mt-sm">
                      <h4>通信生の平均的な月収イメージを教えて下さい。　＊月収＝月給＋手当＋歩合まで含めた1ヶ月の額面給与</h4>
...
export default StylistAssistantTreatment;